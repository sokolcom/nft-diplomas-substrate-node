...
use nft_diplomas_substrate_runtime::{self, opaque::Block, RuntimeApi, SLOT_DURATION};
...
impl sc_executor::NativeExecutionDispatch for ExecutorDispatch {
	...
	fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
		nft_diplomas_substrate_runtime::api::dispatch(method, data)
	}

	fn native_version() -> sc_executor::NativeVersion {
		nft_diplomas_substrate_runtime::native_version()
	}
}
